...
const navigationItems = [
  { href: "/", label: "Accueil", icon: "/icon-soundcloud.svg" },
  {
    href: "/installation",
    label: "Installation",
    icon: "/icon-soundcloud.svg",
  },
  { href: "/procede", label: "Procédé", icon: "/icon-soundcloud.svg" },
  { href: "/historique", label: "Historique", icon: "/icon-soundcloud.svg" },
  { href: "/reglage", label: "Réglage", icon: "/icon-soundcloud.svg" },
  { href: "/alarme", label: "Alarme", icon: "/icon-soundcloud.svg" },
];
