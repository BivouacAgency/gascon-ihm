  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "bg-grey text-white border-0 data-[placeholder]:text-white/80",
        className,
      )}
      {...props}
    >
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 relative z-50 max-h-96 min-w-[8rem] overflow-x-hidden overflow-y-auto rounded-md border shadow-md data-[state=closed]:duration-0 data-[state=open]:duration-0",
          "bg-grey text-white border-0",
          position === "popper" &&
